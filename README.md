...
~~Secondly, I didn't add a way to easily add textures as it is out of the scope of the project. Thanks to Godot the curve has a solid white color when there is no textures.~~ (Textures work now)


I tested this on an office laptop that can run low end games (and barely runs them when the charger is unplugged) and my desktop
